# Conservativity of Betti Realization — Canonical Lane Mathlib

Mathlib-backed Canonical Lane formalization package for the Conservativity of Betti Realization.

## Clean-clone replay

```bash
git clone https://github.com/HautevilleHouse/Betti-realization-mathlib.git
cd Betti-realization-mathlib
lake exe
lake build
```
