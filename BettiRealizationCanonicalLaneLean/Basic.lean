/-!
# Betti-realization Lean migration boundary
...
`Betti_realization/SourcePackage.lean`.
...
def sourceRepository : String := "Betti-realization"
def sourceUrl : String := "https://github.com/HautevilleHouse/Betti-realization"
def sourceDescription : String := "Canonical-lane closure package for the Conservativity of Betti Realization: admissible-class formulation, projection gates, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["Betti-realization", "canonical-lane", "admissible-class", "mathematical-proof", "reproducibility"]
